...
# combined_faces_zip_path = "./combined_faces_train_augmented.zip"
...
train_aug_df['filename'] = train_aug_df['filename'].str.replace('/content/content/', './content/')
test_df['filename'] = test_df['filename'].str.replace('/content/content/', './content/')
...
final_cnn.save(f"./age_model_acc_{round(final_cnn_score[1], 3)}.h5", save_format='h5')
...
def plot_confusion_matrix(cm, classes, normalize=False, title='Confusion Matrix', export_as='confusion_matrix', cmap=plt.cm.Blues):
    ...
    # Exporting plot image in PNG format.
    plt.savefig(f'./cnn_logs/{export_as}.png', bbox_inches='tight');
